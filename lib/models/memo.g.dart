...
final MemoSchema = CollectionSchema(
  name: 'Memo',
  schema:
      '{"name":"Memo","idName":"id","properties":[{"name":"body","type":"String"},{"name":"keywords","type":"StringList"},{"name":"keywordsString","type":"String"},{"name":"name","type":"String"},{"name":"purchaceStore","type":"String"},{"name":"score","type":"Long"},{"name":"shopName","type":"String"},{"name":"tappedOn","type":"Long"}],"indexes":[],"links":[]}',
...
class _MemoWebAdapter extends IsarWebTypeAdapter<Memo> {
  ...
  Object serialize(IsarCollection<Memo> collection, Memo object) {
    ...
    IsarNative.jsObjectSet(jsObj, 'shopName', object.shopName);
  ...
  Memo deserialize(IsarCollection<Memo> collection, dynamic jsObj) {
    ...
    object.shopName = IsarNative.jsObjectGet(jsObj, 'shopName') ?? '';
  ...
  P deserializeProperty<P>(Object jsObj, String propertyName) {
    switch (propertyName) {
      ...
      case 'shopName':
        return (IsarNative.jsObjectGet(jsObj, 'shopName') ?? '') as P;
      case 'tappedOn':
...
class _MemoNativeAdapter extends IsarNativeTypeAdapter<Memo> {
  ...
  void serialize(IsarCollection<Memo> collection, IsarRawObject rawObj,
    ...
    final _score = value5;
    final value6 = object.shopName;
    final _shopName = IsarBinaryWriter.utf8Encoder.convert(value6);
    dynamicSize += (_shopName.length) as int;
    ...
    writer.writeBytes(offsets[6], _shopName);
  ...
  Memo deserialize(IsarCollection<Memo> collection, int id,
    ...
    object.tappedOn = reader.readDateTime(offsets[7]);
    return object;
  }
...
extension MemoQueryFilter on QueryBuilder<Memo, Memo, QFilterCondition> {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameGreaterThan(
    String value, {
    bool caseSensitive = true,
    bool include = false,
  }) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameLessThan(
    String value, {
    bool caseSensitive = true,
    bool include = false,
  }) {
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameBetween(
    String lower,
    String upper, {
    bool caseSensitive = true,
    bool includeLower = true,
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameContains(String value,
      {bool caseSensitive = true}) {
    return addFilterConditionInternal(FilterCondition(
      type: ConditionType.contains,
      property: 'shopName',
  ...
  QueryBuilder<Memo, Memo, QAfterFilterCondition> shopNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return addFilterConditionInternal(FilterCondition(
      type: ConditionType.matches,
...
extension MemoQueryWhereSortBy on QueryBuilder<Memo, Memo, QSortBy> {
  ...
  QueryBuilder<Memo, Memo, QAfterSortBy> sortByShopName() {
    return addSortByInternal('shopName', Sort.asc);
  }

  QueryBuilder<Memo, Memo, QAfterSortBy> sortByShopNameDesc() {
    return addSortByInternal('shopName', Sort.desc);
  }
...
extension MemoQueryWhereSortThenBy on QueryBuilder<Memo, Memo, QSortThenBy> {
  ...
  QueryBuilder<Memo, Memo, QAfterSortBy> thenByShopName() {
    return addSortByInternal('shopName', Sort.asc);
  }

  QueryBuilder<Memo, Memo, QAfterSortBy> thenByShopNameDesc() {
    return addSortByInternal('shopName', Sort.desc);
  }
...
extension MemoQueryWhereDistinct on QueryBuilder<Memo, Memo, QDistinct> {
  ...
  QueryBuilder<Memo, Memo, QDistinct> distinctByShopName(
      {bool caseSensitive = true}) {
    return addDistinctByInternal('shopName', caseSensitive: caseSensitive);
  }
...
extension MemoQueryProperty on QueryBuilder<Memo, Memo, QQueryProperty> {
  ...
  QueryBuilder<Memo, String, QQueryOperations> shopNameProperty() {
    return addPropertyNameInternal('shopName');
  }
